...
window.adminHTML = function() {
  ...
  <div class="admin-content-area animate-fade-in">
    ${renderTabContent(tab, pendingDeposits, pendingOrders)}
  </div>
    `;
};

function renderTabContent(tab, pendingDeposits, pendingOrders) {
    switch(tab) {
        case 'overview': return renderOverview(pendingDeposits, pendingOrders);
...
function renderOverview(pendingDeposits, pendingOrders) {
    return `
